...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_GoogleTerrain_1.setVisible(true);lyr_OpenStreetMap_2.setVisible(false);lyr_PetaDasarATRBPN_3.setVisible(false);lyr_RTRWLABUHANBATUUTARANo5Tahun2015_4.setVisible(false);lyr_RTRWLABUHANBATUNo3Tahun2016_5.setVisible(false);lyr_RDTRRANTAUPRAPATNo21Tahun2022_6.setVisible(false);lyr_KawasanHutanSK6609_7.setVisible(false);lyr_PIPPIB2025_8.setVisible(false);lyr_Komoditas_9.setVisible(false);lyr_HGU_10.setVisible(true);lyr_Batas_Administrasi_11.setVisible(true);lyr_PETA_12.setVisible(true);
...
lyr_RTRWLABUHANBATUUTARANo5Tahun2015_4.set('fieldLabels', {'POLA_RUANG': 'inline label - always visible', 'luas': 'inline label - always visible', });
lyr_RTRWLABUHANBATUNo3Tahun2016_5.set('fieldLabels', {'STRING': 'hidden field', 'TEXTSTRING': 'hidden field', 'TOPONIM': 'inline label - always visible', 'POLA_RUANG': 'inline label - always visible', 'LUAS_1': 'inline label - always visible', });
lyr_RDTRRANTAUPRAPATNo21Tahun2022_6.set('fieldLabels', {'NAMOBJ': 'inline label - always visible', 'NAMZON': 'hidden field', 'KODZON': 'hidden field', 'NAMSZN': 'hidden field', 'KODSZN': 'hidden field', 'JNSRPR': 'hidden field', 'KODEWP': 'hidden field', 'KODSWP': 'hidden field', 'KODBLK': 'hidden field', 'KODSBL': 'hidden field', 'WADMPR': 'hidden field', 'WADMKK': 'inline label - always visible', 'WADMKC': 'inline label - always visible', 'WADMKD': 'inline label - always visible', 'KKOP_1': 'hidden field', 'LP2B_2': 'hidden field', 'KRB_03': 'hidden field', 'TOD_04': 'hidden field', 'TEB_05': 'hidden field', 'PUSLIT': 'hidden field', 'CAGBUD': 'hidden field', 'RESAIR': 'inline label - visible with data', 'KSMPDN': 'hidden field', 'HANKAM': 'hidden field', 'KKARST': 'hidden field', 'PTBGMB': 'hidden field', 'MGRSAT': 'hidden field', 'RDBUMI': 'hidden field', 'TPZ_00': 'hidden field', 'REMARK': 'hidden field', 'LUASHA': 'inline label - always visible', 'Shape_Leng': 'hidden field', 'Shape_Area': 'hidden field', 'PEMOHON': 'hidden field', });
...
lyr_PIPPIB2025_8.set('fieldLabels', {'PIPPIB': 'inline label - always visible', 'NAMOBJ': 'inline label - always visible', 'FCODE': 'hidden field', 'LCODE': 'hidden field', 'SRS_ID': 'hidden field', 'METADATA': 'hidden field', 'REMARK': 'inline label - always visible', });
